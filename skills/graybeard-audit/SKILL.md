...
description: >
  ...
  non-standard framework usage, weak boundaries, contract drift, failure-mode
  gaps, privacy/secrets risk, concurrency bugs, risky dependencies, weak UI
  workflow proof, and overbuilt areas. Report only.
license: MIT
---
