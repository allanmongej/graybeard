...
name: graybeard
description: >
  Repo-aware coding guardrails. Reads instructions and manifests, detects the
  stack, reuses framework/local patterns, applies YAGNI scope control, and
  requires contract, failure-mode, security, privacy, concurrency, dependency,
  UI workflow, and test discipline for risky behavior. Use on coding,
  architecture, dependency, refactor, bug-fix, review, and test-design work.
