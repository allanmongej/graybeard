...
description: >
  ...
  stack-native fit, blast radius, contracts, failure modes, security/privacy
  risks, concurrency, UI workflow proof, meaningful tests, maintainability, and
  needless complexity. Report only.
license: MIT
---
